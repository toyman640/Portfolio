...
const cardObject1 = {
  one: {
    ...
    mobiledesc0: 'Develop a web application aimed at informing prospective delegates about the program of an upcoming summit. The responsive webpage will feature a simple layout.',
  ...
  three: {
    ...
    mobiledesc2: 'Design a desktop webpage that consumes an API, presenting users with a variety of international dishes along with their corresponding ingredients. Users can interact by liking meals and leaving comments for each dish.',
  ...
  four: {
    ...
    mobiledesc3: 'Develop a Python-based web application designed to manage and track essential data related to animal populations. The application will facilitate the recording of animal population metrics, including mortality and births, while also maintaining detailed records for various departments involved in the management of these populations.',
...
const deskObject1 = {
  first: {
    ...
    dsec0: 'Develop a web application aimed at informing prospective delegates about the program of an upcoming summit. The responsive webpage will feature a simple layout.',
  ...
  third: {
    ...
    dsec2: 'Design a desktop webpage that consumes an API, presenting users with a variety of international dishes along with their corresponding ingredients. Users can interact by liking meals and leaving comments for each dish.',
  ...
  fourth: {
    ...
    dsec3: 'Develop a Python-based web application designed to manage and track essential data related to animal populations. The application will facilitate the recording of animal population metrics, including mortality and births, while also maintaining detailed records for various departments involved in the management of these populations.',
